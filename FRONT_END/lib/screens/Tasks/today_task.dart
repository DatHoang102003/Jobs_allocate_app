...
class TodayTaskScreen extends StatefulWidget {
  static const routeName = '/today_tasks';
  final DateTime initialDate;
  const TodayTaskScreen({Key? key, required this.initialDate})
      : super(key: key);
...
class _TodayTaskScreenState extends State<TodayTaskScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      taskProvider.loadTasks(date: widget.initialDate);
  ...
  Widget build(BuildContext context) {
    ...
    final filteredTasks =
        _filterTasks(taskProvider.todayTasks, _selectedFilter);
